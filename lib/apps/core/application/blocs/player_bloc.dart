...
import 'package:vega/apps/core/application/states/player_state.dart';
...
class PlayerBloc extends AsyncBloc<PlayerState>{
  ...
  Future<void> _handlePlayBackStateChanged(PlaybackStateChangedEvent event, Emitter emitter) async{
