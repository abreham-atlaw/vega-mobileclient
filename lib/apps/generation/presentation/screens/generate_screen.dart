...
import 'package:vega/apps/generation/application/states/generate_state.dart';
import 'package:vega/apps/generation/presentation/screens/generating_screen.dart';
import 'package:vega/apps/generation/presentation/screens/select_era_screen.dart';
import 'package:vega/apps/generation/presentation/screens/select_genre_screen.dart';
import 'package:vega/apps/generation/presentation/screens/select_instruments_screen.dart';
import 'package:vega/apps/generation/presentation/screens/select_lyrics_screen.dart';
import 'package:vega/apps/generation/presentation/screens/select_mood_screen.dart';
...
class GenerateScreen extends AsyncBlocScreen<GenerateBloc, GenerateState>{
  ...
  Widget onCreateMain(BuildContext context, GenerateState state) {
    ...
    if(state.stage == QueryStage.play){
      RoutingUtils.redirect("/player/play", context, extra: state.songId!);
      return const SizedBox.shrink();
    }
    return Expanded(
